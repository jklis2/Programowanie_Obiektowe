...
namespace Vehicle
{
    class LandVehicle : Vehicle, ILand
    {
        ...
        public LandVehicle(string _name, FuelType _fuelType, int _horsepower, int _numberOfWheels) : base(_name, _fuelType, _horsepower)
        {
